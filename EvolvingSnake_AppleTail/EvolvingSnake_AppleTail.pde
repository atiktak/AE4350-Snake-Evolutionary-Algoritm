// Evolutionary algoritm learning the play snake
// Written by Albert Tiktak

// Parameters
final int stamina = 5;                      // Number of times the snake can cross the field before running out of energy
final float mutation_factor = 0.05;         // Fraction of the genes that mutates (0-1)
...
boolean initialize = false;                 // When true, the genotype in the current folder is used for gen 1
...
void setup() {
  size(200, 200);    // Size of the playing field (in this case 20 by 20 steps)
  frameRate(2000);
  smooth();
  noStroke();
